## google_benchmark_vendor (rolling) - 0.8.0-1

The packages in the `google_benchmark_vendor` repository were released into the `rolling` distro by running `/usr/local/google/home/sloretz/projects/lyrical/env3/bin/bloom-release -r rolling -t rolling google_benchmark_vendor` on `Tue, 05 May 2026 17:27:48 -0000`
